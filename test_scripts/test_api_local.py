"""
GenAI Security Gateway - Test Api Local Test Betiği

Bu test dosyası 'test_api_local.py', sistemin belirli bir bileşenini test etmek amacıyla oluşturulmuştur.
