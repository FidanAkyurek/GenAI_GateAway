"""
GenAI Security Gateway - Test Db Select Test Betiği

Bu test dosyası 'test_db_select.py', sistemin belirli bir bileşenini test etmek amacıyla oluşturulmuştur.
